...
export declare enum WEB_SOCKET_GATEWAY_STATES {
    DISCONNECTED = "disconnected",
    CONNECTING = "connecting",
    CONNECTED = "connected"
}
export declare type ConnectionProvider = (url: string, options: IWebSocketGatewayConnectionOptions) => ISocket;
 ...
 */
declare class WebSocketGateway extends WebSocketGateway_base {
    ...
    constructor(apiAddress: string, _token: IToken, _options?: IWebSocketGatewayOptions, _connectionProvider?: ConnectionProvider, _userFactory?: (wsGateway: IWebSocketGateway, id: string) => Promise<User>);
    /**
